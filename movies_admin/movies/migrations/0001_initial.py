# Generated by Django 3.2 on 2023-01-22 12:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateField(blank=True, default='', null=True, verbose_name='Creation date')),
                ('file_path', models.FileField(blank=True, default='', null=True, upload_to='', verbose_name='File path')),
                ('rating', models.FloatField(blank=True, default='', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Rating')),
                ('type', models.CharField(choices=[('MV', 'Movie'), ('TV', 'TV show')], default='MV', max_length=255, verbose_name='Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('filmwork', models.ForeignKey(db_column='filmwork_id', on_delete=django.db.models.deletion.CASCADE, to='movies.filmwork', verbose_name='Filmwork')),
        ...
        migrations.AddIndex(
            ...
            index=psqlextra.indexes.unique_index.UniqueIndex(fields=['filmwork', 'person', 'role'], name="content'.'f_filmwor_8a3274_idx"),
        ),
    ]
